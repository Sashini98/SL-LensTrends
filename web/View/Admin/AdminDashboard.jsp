...
<html>
    ...
    <body style="background-color: #f8f9fb;">
        ...
        <div class="side-nav">
            ...
            <div id="notifyDiv" onclick="show('notifyDiv')" onmouseover="notifyButtonChange('notifyDiv')" onmouseout="notifyButtonBack('notifyDiv')" class="notification">
            ...
            <div id="settingDiv" onclick="show('settingDiv')" onmouseover="settingButtonChange('settingDiv')" onmouseout="settingButtonBack('settingDiv')" class="summary">
                <img id="settingIcon" src="../../Resources/Img/settings.svg" />
                <p><a href="#" type="button"  id="settingtext">Settings</a></p>
            </div>

            <div id="logoutDiv" onmouseover="logoutButtonChange('logoutDiv')" onmouseout="logoutButtonBack('logoutDiv')" class="summary">
                <img id="logoutIcon" src="../../Resources/Img/logout.svg" />
                <p><a href="#" type="button"  id="logouttext">logout</a></p>
            </div>
        </div>

        <div class="DashboardBody" style="margin-left: 20%;" >
