...
<html>
    ...
    <body>
        ...
        <div class="contain">
        <div class="leftp">
            <input type="button"value="Ongoing Events" onclick="location.href = 'EventHome.jsp'"><br><br><br>
            <input type="button" value="Post an Event" onclick="location.href = 'EventsPost.jsp'"><br>
            <input type="button"  class="active" value="Past Events"><br>

        </div>
        
            &emsp;<h9>Past Events</h9><br><br>   
        ...
        <div class="rightp">
             <div class="sec" style=" border-top: 10px solid darkviolet; ">
                    ...
                    <a href="">Photographer</a><br><br>
                    <input type="button" value="Rate Photographer" onclick="location.href = '../Photographer/UserViewPhotographerProfile.jsp'" ><br>
